      ...
      try {
        ...
        if (!isCancelled && res) {
          const mappedItems: Business[] = (res.items || []).map((hit: any) => ({
            ...
            phone: hit.contactAvailability?.hasPhone ? (hit.isUnlocked ? hit.phone : '+91 98*** ***10') : null,
            email: hit.contactAvailability?.hasEmail ? (hit.isUnlocked ? hit.email : 'c***@domain.in') : null,
            ...
            website: hit.contactAvailability?.hasWebsite ? 'https://example.com' : null,
